...
use App\Http\Middleware\CheckSelectedCompany;
...
class Kernel extends HttpKernel
{
    ...
    protected $middlewareAliases = [
        ...
        'checkVerified' => CheckEmailVerification::class,
        'checkSelectedCompany' => CheckSelectedCompany::class,
    ];
}
