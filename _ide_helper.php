...
namespace Illuminate\Support\Facades {
     ...
     */        class DB {
        ...
        {            //Method inherited from \Illuminate\Database\Connection
                    ...
                    /**
         * Run an edit statement against the database.
         *
         * @param string $query
         * @param array $bindings
         * @return int
...
namespace Rakutentech\LaravelRequestDocs {
     ...
     */        class LaravelRequestDocsFacade {
         ...
         * This method also read docBlock and edit into {@see \Rakutentech\LaravelRequestDocs\Doc}.
         *
         * @param \Illuminate\Support\Collection<int, \Rakutentech\LaravelRequestDocs\Doc> $docs
         * @return \Illuminate\Support\Collection<int, \Rakutentech\LaravelRequestDocs\Doc>
         * @throws \ReflectionException
...
namespace  {
             ...
             */            public static function createOrFirst($attributes = [], $values = [])
            {
                            ...
                            /**
             * Create or edit a record matching the attributes, and fill it with values.
             *
             * @param array $attributes
             * @param array $values
             * @return \Illuminate\Database\Eloquent\Model|static
             ...
             */            public static function forceCreateQuietly($attributes = [])
            {
                            ...
                            /**
             * Insert new records or edit the existing ones.
             *
             * @param array $values
             ...
             */            public static function insertOrIgnoreUsing($columns, $query)
            {
                            ...
                            /**
             * Update records in a PostgreSQL database using the edit from syntax.
             *
             * @param array $values
             * @return int
             * @static
             */            public static function updateFrom($values)
            {
                            ...
                            /**
             * Insert or edit a record matching the attributes, and fill it with values.
             *
             * @param array $attributes
             * @param array $values
             * @return bool
