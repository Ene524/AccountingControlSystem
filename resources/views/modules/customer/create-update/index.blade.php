                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-9">
                                            <select id="is_person"
                                                ...
                                                <option value="1" {{ old('is_person', isset($response) && $response->isSuccess() ? $response->getData()->is_person : '') == 1 ? 'selected' : '' }}>
                                                    Evet
                                                </option>
                                                <option value="0" {{ old('is_person', isset($response) && $response->isSuccess() ? $response->getData()->is_person : '') == 0 ? 'selected' : '' }}>
                                                    Hayır
                                                </option>
                                            </select>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <select id="is_active"
                                        ...
                                        <option value="1" {{ old('is_active', isset($response) && $response->isSuccess() ? $response->getData()->is_active : '') == 1 ? 'selected' : '' }}>
                                            Evet
                                        </option>
                                        <option value="0" {{ old('is_active', isset($response) && $response->isSuccess() ? $response->getData()->is_active : '') == 0 ? 'selected' : '' }}>
                                            Hayır
                                        </option>
                                    </select>
                                    <span class="help-block error-help-block mx-1">
