...
@section('content')
    ...
    <div class="row">
        <div class="col-xxl">
            <div class="card mb-4">
                <div class="card-body">
                    <form action="{{ route('product.edit', ['id' => $response->getData()->id]) }}"
                          method="post">@csrf
                        <div class="row">
                            ...
                            <div class="col-sm-9"
                                ...
                                <div class="form-check form-check-inline"
                                    ...
                                    <input class="form-check-input"
                                           ...
                                           name="type"
                                           value="1"
                                           {{ old('type') == 1 || $response->getData()->type == 1 ? 'checked' : '' }}>
                                ...
                                <div class="form-check form-check-inline"
                                    ...
                                    <input class="form-check-input"
                                           ...
                                           name="type"
                                           value="2"
                                           {{ old('type') == 2 || $response->getData()->type == 2 ? 'checked' : '' }}>
                                    <label class="form-check-label"
                                           for="type2">Hizmet
                                    </label>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <select class="form-control select2"
                                        ...
                                        id="vat">
                                    <option value="0"
                                            {{ $response->getData()->vat == 0 ? 'selected' : '' }}>
                                        0%
                                    </option>
                                    <option value="1"
                                            {{ $response->getData()->vat == 1 ? 'selected' : '' }}>
                                        1%
                                    </option>
                                    <option value="10"
                                            {{ $response->getData()->vat == 10 ? 'selected' : '' }}>
                                        10%
                                    </option>
                                    <option value="20"
                                            {{ $response->getData()->vat == 20 ? 'selected' : '' }}>
                                        20%
                                    </option>
                                </select>
                                ...
                                <select class="form-control"
                                    ...
                                    @foreach ($units as $unit)
                                        <option value="{{ $unit->id }}"
                                                {{ $unit->id == $response->getData()->unit_id ? 'selected' : '' }}>
                                            {{ $unit->name }}</option>
                                    @endforeach
                                </select>
                                <span
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                                <select class="form-control select2"
                                        ...
                                        disabled>
                                    <option value="">Seçiniz</option>
                                    @foreach ($witholdings as $witholding)
                                        <option value="{{ $witholding->id }}"
                                                {{ $witholding->id == $response->getData()->witholding_id ? 'selected' : '' }}>
                                            {{ $witholding->code . ' - ' . $witholding->name . '-' . $witholding->numerator . '/10' }}
                                        </option>
                                    @endforeach
                                </select>
                                <span
                            ...
                            <div class="col-sm-4">
                                <select class="form-control select2"
                                    ...
                                    @foreach ($taxExemptions as $taxExemption)
                                        <option value="{{ $taxExemption->id }}"
                                                {{ $taxExemption->id == $response->getData()->tax_exemption_id ? 'selected' : '' }}>
                                            {{ $taxExemption->code . ' - ' . $taxExemption->name }}</option>
                                    @endforeach
                                </select>
                                <span
                            ...
                            <div class="col-sm-5">
                                <select class="form-control select2"
                                    ...
                                    @foreach ($taxes as $tax)
                                        <option value="{{ $tax->id }}"
                                                {{ $tax->id == $response->getData()->tax_id ? 'selected' : '' }}>
                                            {{ $tax->code . ' - ' . $tax->name }}</option>
                                    @endforeach
                                </select>
